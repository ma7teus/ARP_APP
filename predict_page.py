...
def show_predict_page():
    ...
    with col01:
        ...
        dance = st.checkbox('Dance/IDM',value=False,disabled=False)
    ...
    with col1:
        ...
        mysterious = st.checkbox('Mysterious/Cryptic',value=False,disabled=False)
    ...
    with col2:
        ...
        atmospheric = st.checkbox('Atmospheric/Hypnotic',value=False,disabled=False)
        energetic = st.checkbox('Energetic/Rush',value=False,disabled=False)
        ...
        sombre = st.checkbox('Sombre/Nocturnal',value=False,disabled=False)
    ...
    with col3:
        ...
        mellow = st.checkbox('Mellow/Warm',value=False,disabled=False)
        passionate = st.checkbox('Passionate',value=False,disabled=False)
        sad = st.checkbox('Sad/Depressive',value=False,disabled=False)
    ...
    with col4:
        ...
        acoustic = st.slider('Measures the usage of acoustic and non-eletronic instruments in the track. Value 1, least acoustic. Value 5, most acousitc.',1,5)
        st.subheader("""Instrumentalness""")
        instrumentalness = st.slider('Measures the presence of vocals in the track. Value 1, higher presence of vocals. Value 5, higher presence of instruments.',1,5)

    with col6:
        st.subheader("""Danceability""")
        danceability = st.slider('Measures how suitable the tracks for dancing based on the rhythm, tempo and beat strength. Value 1, least danceable. Value 5, most danceable.',1,5)
